        ...
        <div className={styles.newsContainer}>
          ...
          <div className={styles.newsGrid}>
            <div className={styles.newsCard}>
              ...
              <ul>
                <li>유튜브: @petros-church</li>
                <li>온라인 헌금: 신협 131-017-687642</li>
                <li>다음세대 후원: 신협 131-018-242250</li>
              </ul>
            </div>
            ...
            <div className={styles.newsCard}>
              <h3>2. 이번 주 예배 주제</h3>
              <ul>
                <li>주일오전: 무릎 꿇으신 기도자 (눅 22:39~44)</li>
                <li>수요저녁: 창세기 45:4-10 (통성기도 및 합심기도)</li>
                <li>금요기도: [기도] 책</li>
                <li>새벽예배: QT책 진도를 따라</li>
              </ul>
            </div>
            ...
            <div className={styles.newsCard}>
              <h3>4. 이음돌 아우팅 안내</h3>
              <p>오늘은 점심 식사가 없으며, 각 이음돌 모임별로 아우팅 시간을 보냅니다. (오후예배 없음)</p>
              <p>※ 단, 주일학교와 어르신들에게는 김밥을 제공해 드립니다.</p>
            </div>

            <div className={styles.newsCard}>
              <h3>5. 다음세대 예배 소식</h3>
              <ul>
                <li><strong>주일청소년 (오전 10시):</strong> 예수님의 십자가 (막 15장). 성경적 세계관으로 준비된 청소년 되어요.</li>
                <li><strong>주일어린이 (오전 11시):</strong> 구레네 시몬 (막 15:21). 사순절 가정학습지를 함께해요.</li>
              </ul>
            </div>

            <div className={styles.newsCard}>
              <h3>6. 고난주간 특별새벽기도</h3>
              <p>내일부터 고난주간 특별 새벽기도를 준비합니다. 깊은 은혜를 체험하시기 바랍니다.</p>
              <p><strong>기간:</strong> 3월 30일(월) ~ 4월 3일(금) / 5일간</p>
            </div>

            <div className={styles.newsCard}>
              <h3>7. 부활절 및 연합 세례식</h3>
              <p>다음 주일은 예수님의 부활을 축하하며 세례식도 함께 진행합니다. (세례자: 설하나 자매님)</p>
            </div>

            <div className={styles.newsCard}>
              <h3>8. 성전 보수 및 새생명 축제</h3>
              <p>성전 안팎의 보수공사를 진행하고 있습니다. 귀하게 사용하겠습니다. 아울러 다가오는 새생명 축제(4월 12일 작정)를 위해 기도해 주시길 바랍니다.</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className={styles.scheduleTableWrap}>
            <table className={styles.scheduleTable}>
              <tbody>
                <tr>
                  <th>주일대예배 (1부)</th>
                  <td><span className={styles.time}>오전 09:00</span></td>
                  <td>2층 본당</td>
                  <td>이주민 목사</td>
                </tr>
                <tr>
                  <th>주일대예배 (2부)</th>
                  <td><span className={styles.time}>오전 11:00</span></td>
                  <td>2층 본당</td>
                  <td>이주민 목사</td>
                </tr>
                <tr>
                  <th>주일오후예배</th>
                  <td><span className={styles.time}>오후 14:00</span></td>
                  <td>2층 본당</td>
                  <td>이주민 목사</td>
                </tr>
                <tr>
                  <th>중고등부예배</th>
                  <td><span className={styles.time}>오전 10:00</span></td>
                  <td>3층 교육관</td>
                  <td>김민정 전도사</td>
                </tr>
                <tr>
                ...
                <tr>
                  <th>수요저녁예배</th>
                  <td><span className={styles.time}>저녁 19:30</span></td>
                  <td>2층 본당</td>
                  <td>이주민 목사</td>
                </tr>
                <tr>
                  <th>금요기도회</th>
                  <td><span className={styles.time}>저녁 20:00</span></td>
                  <td>2층 본당</td>
                  <td>이주민 목사</td>
                </tr>
                <tr>
                  <th>새벽예배</th>
                  <td><span className={styles.time}>오전 05:30</span></td>
                  <td>2층 본당</td>
                  <td>이주민 목사</td>
                </tr>
              </tbody>
